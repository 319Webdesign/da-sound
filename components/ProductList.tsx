                  ...
                  <div className="grid grid-cols-3 gap-3 mb-4">
                    {product.specs
                      ...
                      .map((spec, idx) => {
                        ...
                        const displayValue = (spec.value || '').replace(/\s*\(bluetooth\)\s*/gi, '').trim();
                        return (
                  ...
                  {(() => {
                    ...
                    if (product.priceOptions && product.priceOptions.length > 0) {
                          ...
                          {product.priceOptions.map((option, idx) => (
                            <div key={idx} className="text-sm">
                              ...
                              <span className="text-lg font-bold text-primary">
                                {product.priceFrom ? 'Ab ' : ''}{option.price.toFixed(2).replace('.', ',')} €{priceSuffix}{product.priceNote ? '*' : ''}
                              </span>
                            </div>
                          ))}
                        </div>
                      ...
                      return (
                        <>
                          <div className="text-xl font-bold text-primary">
                            {product.priceFrom ? 'Ab ' : ''}{product.pricePerUnit.toFixed(2).replace('.', ',')} € / {product.priceUnitLabel ?? ((product.id === 'akku-lautsprecher-compact' || product.id === 'akku-lautsprecher-maxi' || product.id === 'aktivlautsprecher-bluetooth' || product.id === 'pa-saeule-bluetooth' || product.id === 'sub-sat-set-bluetooth' || product.id === 'pa-set-small' || product.id === 'pa-set-medium' || product.id === 'pa-set-large' || product.id === 'pa-set-xlarge' || product.id === 'pa-set-premium-mini' || product.id === 'pa-set-premium' || product.id === 'pa-set-pro-500' || product.id === 'pa-set-pro-800' || product.id === 'pa-set-outdoor' || product.id === 'party-set-small' || product.id === 'party-set-medium' || product.id === 'party-set-white' || product.id === 'party-set-large' || product.id === 'party-set-xlarge') ? 'Tag' : 'Stück')}{product.priceNote ? '*' : ''}
                          </div>
                          {product.priceNote && (
                            <div className="text-sm text-gray-500">*{product.priceNote}</div>
                          )}
                          {product.pricePerPair && (
                            <div className="text-sm text-gray-500">
                              {product.pricePerPair.toFixed(2).replace('.', ',')} € / {(product.priceUnitLabel === 'Tag' || product.id === 'akku-lautsprecher-compact' || product.id === 'akku-lautsprecher-maxi' || product.id === 'aktivlautsprecher-bluetooth' || product.id === 'pa-saeule-bluetooth' || product.id === 'sub-sat-set-bluetooth' || product.id === 'pa-set-small' || product.id === 'pa-set-medium' || product.id === 'pa-set-large' || product.id === 'pa-set-xlarge' || product.id === 'pa-set-premium-mini' || product.id === 'pa-set-premium' || product.id === 'pa-set-pro-500' || product.id === 'pa-set-pro-800' || product.id === 'pa-set-outdoor' || product.id === 'party-set-small' || product.id === 'party-set-medium' || product.id === 'party-set-white' || product.id === 'party-set-large' || product.id === 'party-set-xlarge') ? 'Wochenende' : 'Paar'}
                            </div>
                          )}
                        </>
                      );
