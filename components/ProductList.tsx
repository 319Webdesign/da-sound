                  ...
                  {(() => {
                    ...
                    if (product.priceOptions && product.priceOptions.length > 0) {
                      ...
                      return (
                        <>
                          <div className="text-xl font-bold text-primary">
                            {product.pricePerUnit.toFixed(2).replace('.', ',')} € / {product.priceUnitLabel ?? ((product.id === 'akku-lautsprecher-compact' || product.id === 'akku-lautsprecher-maxi' || product.id === 'aktivlautsprecher-bluetooth' || product.id === 'pa-saeule-bluetooth' || product.id === 'sub-sat-set-bluetooth' || product.id === 'pa-set-small' || product.id === 'pa-set-medium' || product.id === 'pa-set-large' || product.id === 'pa-set-xlarge' || product.id === 'pa-set-premium' || product.id === 'pa-set-pro-500' || product.id === 'pa-set-pro-800' || product.id === 'pa-set-outdoor' || product.id === 'party-set-small' || product.id === 'party-set-medium' || product.id === 'party-set-white' || product.id === 'party-set-large' || product.id === 'party-set-xlarge') ? 'Tag' : 'Stück')}
                          </div>
