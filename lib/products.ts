...
der Nebelmaschine.`,
    images: [
      ...
      '/images/partysetMEDIUM/antariz8002.webp',
      '/images/partysetMEDIUM/klsscan.webp',
      '/images/partysetMEDIUM/klsscan2.webp',
      '/images/partysetMEDIUM/klsscan3.webp',
      '/images/partysetMEDIUM/pasubsat.webp',
      '/images/partysetMEDIUM/profx6v3.webp',
    ],
    pricePerUnit: 140,
    pricePerPair: 200,
    categorySlug: 'party-sets-ton-licht',
...
Mikrofon oder anstatt des LED Licht-Sets.`,
    images: [
      ...
      '/images/partysetWHITE/41700503d.webp',
      '/images/partysetWHITE/b40mk2.webp',
      '/images/partysetWHITE/DAS10435063.webp',
      '/images/partysetWHITE/kls_ws1.webp',
...
Lichteffekt anstatt der Nebelmaschine.`,
    images: [
      ...
      '/images/party set LARGE/51741091g.webp',
      '/images/party set LARGE/beyertg550.webp',
      '/images/party set LARGE/clubset.webp',
      '/images/party set LARGE/profx3-500f9721.webp',
      '/images/party set LARGE/profx3.webp',
      '/images/party set LARGE/profx6v3.webp',
      '/images/party set LARGE/z1200.webp',
    ],
    pricePerUnit: 180,
    pricePerPair: 250,
    categorySlug: 'party-sets-ton-licht',
...
Lichteffekt anstatt der Nebelmaschine.`,
    images: [
      ...
      '/images/party set X-LARGE/beyertg550.webp',
      '/images/party set X-LARGE/hz350.webp',
      '/images/party set X-LARGE/klslaserbarpro.webp',
      '/images/party set X-LARGE/profx8side.webp',
      '/images/party set X-LARGE/Set_XL2.webp',
    ],
    pricePerUnit: 249,
    pricePerPair: 350,
    categorySlug: 'party-sets-ton-licht',
...
Abholung mit der von uns empfohlenen Voreinstellung.`,
    images: [
      ...
      '/images/akku lautsprecher kompakt/ev8_2.webp',
...
Abholung mit der von uns empfohlenen Voreinstellung.`,
    images: [
      ...
      '/images/akku lautsprecher maxi/rockster2.webp',
...
Abholung mit der von uns empfohlenen Voreinstellung.`,
    images: [
      ...
      '/images/sub sat bluetooth/molly2.webp',
      '/images/sub sat bluetooth/molly3.webp',
      '/images/sub sat bluetooth/molly4.webp',
    ],
    pricePerUnit: 49,
    pricePerPair: 70,
    categorySlug: 'pa-anlagen',
...
Abholung mit der von uns empfohlenen Voreinstellung.`,
    ...
    specs: [
      ...
      { label: 'Schalldruck', value: '121 dB' },
      { label: 'Bluetooth', value: 'Nein, optional mit Upgrade Pack' },
...
Abholung mit der von uns empfohlenen Voreinstellung.`,
    ...
    pricePerPair: 120,
    categorySlug: 'pa-anlagen',
    offerInfo: 'Für noch mehr "POWER" kann das System durch 1 weiteren 15er Subwoofer erweitert werden, um einen deutlich stärkeren Basspegel zu erzielen. Optimal für DJ-Anwendungen. Aufpreis für 1 weiteren Sub nur 15,- €',
    specs: [
      { label: 'Personen', value: '1-100' },
      { label: 'Indoor', value: 'Indoor' },
      { label: 'Leistung', value: '2.000W' },
...
Abholung mit der von uns empfohlenen Voreinstellung.`,
    ...
    pricePerPair: 220,
    categorySlug: 'pa-anlagen',
    offerInfo: 'Für noch mehr "POWER" kann das System durch 2 weitere 18er Subbässe erweitert werden. Damit lassen sich dann noch mehr Personen mit massivem Basspegel beschallen. Aufpreis für 2 weitere Subs: 50,- €',
    specs: [
...
Dieses Platzwunder überrascht durch einen druckvollen Bass, transparente Mitten und glasklare Höhen. In Minutenschnelle aufgebaut, lassen sich damit problemlos 100-150 Personen beschallen. Dabei passt es auf die Rücksitzbank eines PKW.`,
    images: [
      '/images/PA Set PREMIUM mini/premium_mini1.png',
    ...
    specs: [
      ...
      { label: 'Gewicht', value: 'ca. 75kg' },
      { label: 'Transport', value: 'PKW / Kleinwagen' },
    ],
  },
  {
    id: 'pa-set-premium',
...
3,5 kg / Stck`,
  ...
  {
    id: 'theatre-spot-rgb',
    name: 'Theatre Spot RGB',
    description: 'Einfacher, breit abstrahlender Theaterscheinwerfer mit Torblenden. Zur farbigen Ausleuchtung kleiner Bühnen, Beleuchtung von Objekten oder dekorativem Ambientelicht. Durch 2 variable Bügel können die Scheinwerfer auch stehend auf dem Boden betrieben werden.',
    detailDescription: `Theatre Spot RGB
Einfacher, breit abstrahlender Theaterscheinwerfer mit Torblenden. Zur farbigen Ausleuchtung kleiner Bühnen, Beleuchtung von Objekten oder dekorativem Ambientelicht. Durch 2 variable Bügel können die Scheinwerfer auch stehend auf dem Boden betrieben werden.`,
    images: [
      '/images/Theatre Spot RGB/theatre_cob100a.webp',
      '/images/Theatre Spot RGB/theatre_cob100b.webp',
      '/images/Theatre Spot RGB/theatre_cob100c.webp',
    ],
    galleryImages: [
      '/images/Theatre Spot RGB/theatre_cob100b.webp',
      '/images/Theatre Spot RGB/theatre_cob100c.webp',
    ...
    categorySlug: 'statische-scheinwerfer-led-spots',
    specs: [
      { label: 'Leistung', value: '100 Watt COB LED' },
      { label: 'Indoor', value: 'Indoor' },
      { label: 'Farbton', value: 'RGB & warmweiß' },
